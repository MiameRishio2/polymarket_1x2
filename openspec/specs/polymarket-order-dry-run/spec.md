...
Define the read-only Polymarket order lifecycle simulation, including validated decimal intents, an abstract asynchronous executor, deterministic mock behavior, quote gating, and fail-closed cancellation without live trading capability.
